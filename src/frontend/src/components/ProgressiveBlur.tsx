...
export function ProgressiveBlur({
  ...
  const getPositionStyles = (pos: "top" | "bottom" | "both"): React.CSSProperties => {
    if (pos === "top") return { top: 0, left: 0, right: 0 }
    if (pos === "bottom") return { bottom: 0, left: 0, right: 0 }
    return { top: 0, bottom: 0, left: 0, right: 0 }
  }

  return (
    <div
      className={`gradient-blur pointer-events-none absolute z-10 ${className}`}
      style={{
